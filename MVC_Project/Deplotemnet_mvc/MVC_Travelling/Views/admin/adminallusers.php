                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <p class="mb-0 fw-normal"><?php echo $value->cityname; ?></p>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                if ($value->roll_id != 1) { ?>
                                                    ...
                                                    <a href="edit?userid=<?php echo $value->id; ?>">
                                                        <span class="badge bg-primary rounded-1 fw-semibold"><i class="fa-solid fa-file-pen"></i></span>
                                                    </a>
                                                    <a href="delete?userid=<?php echo $value->id; ?>">
                                                        <span class="badge bg-danger rounded-1 fw-semibold"><i class="fa-sharp fa-solid fa-trash"></i></span>
                                                    </a>
                                                <?php } ?>
                                            </div>
                                        </td>
